var A = "Hello People!! "+"How are you all doing?"; //popup alert box  with concataneted text
window.alert(A);                                    //alert box
var Team = "Ferrari ", Driver = "Sainz ", principle = "Vasseur "; //Defined variatin family
